...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "After taking my car here for a repair that 3 other garages in rugby misdiagnosed - I can honestly say they are highly professional, quick with the repairs, an outstanding service and I wouldn’t hesitate to come back for any future work for mine and my partners car.",
    name: "Georgia Earle",
  },
